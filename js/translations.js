const translations = {
    en: {
        ...
        "articlefull4.title": "9 Blessings Needed in Old Age",
        "articlefull4.author": "By Rev. Choi Jong-in",
        "articlefull4.date": "November 25, 2024",
        "articlefull4.content": "<p>I have long been interested in ministry for the elderly. Peace Church's ministry for the elderly proceeds in three directions: ministry within the church, community outreach, and nursing home missions.</p><p>In old age, we experience inevitable transitions. It is best to spend old age in one's own home ('Aging in Place'), but we must prepare for the blessings needed in this season of life.</p><h2>1. Blessing of Health</h2><p>Spending a healthy old age is everyone's dream. However, 9 out of 10 elderly people face health challenges. Life expectancy is 82.4 years, but healthy life expectancy is only 64.9 years. We must receive the blessing of health, praying like John: \"Beloved, I pray that you may prosper in all things and be in health, just as your soul prospers\" (3 John 1:2).</p><h2>2. Blessing of Work</h2><p>The elderly need work not just for income, but to confirm their social roles and values. Moses was a shepherd at 80, Daniel served as prime minister past 80, and Caleb at 85 asked for pioneer land. Through work, the elderly maintain dignity and purpose.</p><h2>3. Blessing of Family</h2><p>Family provides psychological stability and comfort for the elderly. Like Cornelius's family that feared God and prayed together, healthy families become safe havens where the elderly find peace and belonging.</p><h2>4. Blessing of Finances</h2><p>Economic independence in old age protects dignity and enables service. Like Barzillai who helped King David, elderly saints need financial blessings to live abundantly and serve others.</p><h2>5. Blessing of Faith</h2><p>Having faith in old age is essential for 'successful aging.' Faith strengthens well-being, reduces depression, and helps interpret life's challenges through a religious lens. The fellowship of faith is vital for a successful old age.</p><h2>6. Blessing of Friends</h2><p>Good friends increase happiness, reduce stress, and help cope with life transitions. Like Daniel's three friends, we need companions who share our faith, pray together, and endure trials alongside us.</p><h2>7. Blessing of Dwelling</h2><p>A stable dwelling is crucial for the elderly. Like Abraham's tent where hospitality was practiced and couples aged together, our dwelling should be a place of welcome, health, and companionship.</p><h2>8. Blessing of Wisdom</h2><p>Discernment is essential in old age. We need wisdom to make clear judgments, consume information wisely, and maintain dignity. The blessing of wisdom helps us navigate the complexities of aging.</p><h2>9. Blessing of Heaven</h2><p>Finishing life well is crucial. Just as we prepare to move homes, we must prepare to move to heaven. The hope of heaven gives meaning to our final season. I recommend going to heaven together—this is the ultimate blessing we can share.</p><p>Materials are abundant, but the best thing a pastor can give is blessing. Therefore, proclaim these 9 blessings of old age and pray powerfully for them to come.</p><p><strong>Rev. Choi Jong-in [Peace Church / Editorial Writer]</strong></p>"
    },
    ko: {
        "nav.home": "홈",
        "nav.books": "저서",
        ...
        "articlefull4.title": "노년에 필요한 9가지 축복",
        "articlefull4.author": "최종인 목사",
        "articlefull4.date": "2024년 11월 25일",
        "articlefull4.content": "<p>저는 오래전부터 노인목회에 관심이 많았습니다. 평화교회의 노인 사역은 세 가지 방향으로 진행됩니다: 교회 안의 노인 사역, 지역 대상 사역, 그리고 요양원 선교입니다.</p><p>노년에는 필연적인 이동이 있습니다. 'Aging in Place'로 자택에서 노년을 보내는 것이 최상이지만, 이 시기에 필요한 축복들을 준비해야 합니다.</p><h2>1. 건강 축복</h2><p>건강한 노년을 보내는 것은 모든 이의 꿈입니다. 그러나 노인 10명 중 9명은 아픈 것이 현실입니다. 기대수명은 82.4세이지만, 건강수명은 64.9세에 그칩니다. 요한 사도의 축복처럼 강건함의 축복을 받아야 합니다: \"사랑하는 자여 네 영혼이 잘됨 같이 네가 범사에 잘되고 강건하기를 내가 간구하노라\"(요삼 1:2).</p><h2>2. 일터 축복</h2><p>노인에게도 일이 필요합니다. 단지 경제적인 이유만이 아니라 사회적 역할과 가치를 확인하기 위해서입니다. 모세는 80세에 목자였고, 다니엘은 80이 넘어서도 총리로 섬겼으며, 갈렙은 85세에 개척지를 달라고 했습니다. 일을 통해 노인들은 존엄과 목적을 유지합니다.</p><h2>3. 가정 축복</h2><p>가정은 노인에게 심리적 안정감과 편안함을 제공합니다. 하나님을 경외하고 함께 기도하는 고넬료의 가정처럼, 건강한 가정은 노인이 평안과 소속감을 찾는 안전한 피난처가 됩니다.</p><h2>4. 재정 축복</h2><p>노년의 경제적 독립은 존엄을 지키고 섬김을 가능하게 합니다. 다윗왕을 도운 바르실래처럼, 노년의 성도들은 넉넉하게 살고 다른 이들을 섬기기 위해 재정 축복이 필요합니다.</p><h2>5. 신앙 축복</h2><p>노년에 신앙을 갖는 것은 '성공적 노화'의 필수 조건입니다. 신앙은 안녕감을 강화하고, 우울증을 저하시키며, 삶의 도전을 종교적으로 해석하도록 돕습니다. 신앙의 교제는 성공적인 노후를 위해 필수적입니다.</p><h2>6. 친구 축복</h2><p>좋은 친구는 행복을 증가시키고, 스트레스를 줄이며, 인생 전환기에 대처하도록 돕습니다. 다니엘의 세 친구처럼, 우리는 신앙을 공유하고, 함께 기도하며, 시험을 함께 견디는 동반자가 필요합니다.</p><h2>7. 장막 축복</h2><p>안정된 거처는 노인에게 매우 중요합니다. 환대가 실천되고 부부가 함께 늙어가는 아브라함의 장막처럼, 우리의 거처는 환영과 건강과 동반자 관계의 장소가 되어야 합니다.</p><h2>8. 지혜 축복</h2><p>분별력은 노년에 필수적입니다. 명확한 판단을 내리고, 정보를 현명하게 소비하며, 존엄을 유지하기 위해 지혜가 필요합니다. 지혜의 축복은 노화의 복잡성을 헤쳐 나가도록 돕습니다.</p><h2>9. 천국 축복</h2><p>인생을 잘 마무리하는 것은 매우 중요합니다. 이사 준비를 하듯 천국 이사 준비가 필요합니다. 천국의 소망은 우리의 마지막 계절에 의미를 부여합니다. 함께 천국에 가자고 권합니다—이것이 우리가 나눌 수 있는 궁극의 축복입니다.</p><p>자료는 차고 넘치지만, 목사가 성도들에게 베풀 수 있는 최고의 것은 축복입니다. 그러므로 노년의 축복 9가지를 선포하시고 축복이 임하도록 강력하게 기도하십시오.</p><p><strong>최종인 목사 [평화교회/본지 논설위원]</strong></p>"
    }
};
